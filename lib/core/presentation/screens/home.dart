...
import 'package:safesuit_bank/core/presentation/bloc/home/home_bloc.dart';
...
import 'package:safesuit_bank/data/repositories/home_repository_impl.dart';
...
class HomeView
  ...
  Widget
    ...
    return BlocProvider(
      create: (context) => HomeBloc(LoadHomeData(HomeRepositoryImpl()))..add(LoadHomeDataEvent()),
      child: Scaffold(
        ...
        drawer: NavigationDrawer(children: [
          ...
          ListTile(
              ...
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const TransUser()));
              }),
          ListTile(
          ...
          child: SingleChildScrollView(child: BlocBuilder<HomeBloc, HomeState>(
            builder: (context, state) {
              return Column(
                ...
                children: [
                  Text(
                    'Bienvenido ${state.name} ${state.lastName}',
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 25,
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Material(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => RetirarQR()));
                                },
                                borderRadius: BorderRadius.circular(8),
                                child: Container(
                                  width: 70,
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: const CircleAvatar(
                                  radius: 30,
                                  backgroundImage: AssetImage('assets/images/logo_aguakan.jpg'),
                                ),
                              ),
                            ),
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: const CircleAvatar(
                                  radius: 30,
                                  backgroundImage: AssetImage('assets/images/logo_telcel.png'),
                                ),
                              ),
                            ),
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: const CircleAvatar(
                                  radius: 30,
                                  backgroundImage: AssetImage('assets/images/logo_cfe.jpg'),
                                ),
                              ),
                            ),
                          ],
                        ),
                        const SizedBox(height: 50), // Agrega espaciado al final si es necesario
                      ],
                    ),
                  )
                ],
      ...
      child: Stack(
        children: <Widget>[
          ...
          Align(
            ...
            child: Padding(
              padding: const EdgeInsets.only(top: 12.0), // Ajuste según sea necesario
          ...
          Align(
            ...
            child: Padding(
              padding: const EdgeInsets.only(bottom: 12.0), // Ajuste según sea necesario
