...
class _TransAguaState extends State<TransAgua> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => PagaraguakanBloc(LoadPagaraguakanData(PagaraguakanRepositoryImpl()))
        ..add(LoadPagaraguakanDataEvent()),
      child: BlocBuilder<PagaraguakanBloc, PagaraguakanState>(
        builder: (context, state) {
          ...
          TextEditingController NIAController = TextEditingController(
            text: state.NIA,
          );
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          onChanged: (value) {
                            context.read<PagaraguakanBloc>().add(ImporteChanged(double.tryParse(value) ?? 0.0));
                          },
                        ),
                      ),
                      const SizedBox(height: 25.0),
